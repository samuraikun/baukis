...
ActiveRecord::Schema.define(version: 20170114055319) do
  ...
  create_table "staff_members", primary_key: "member_id", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "email",                            null: false
    t.string   "email_for_index",                  null: false
